...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  if($raw!==''){
    ...
    foreach($lines as $ln){
      ...
      if(!filter_var($e,FILTER_VALIDATE_EMAIL)){ $errors[]="Ungültige Adresse: $e"; continue; }
      $ins->execute([':e'=>$e]);
    }
  }
...
$emails=$pdo->query("SELECT email FROM whitelist ORDER BY email ASC")->fetchAll(PDO::FETCH_COLUMN);

page_header('Whitelist');
?>
<h1 class="mb-3">Whitelist</h1>
